...
const project = {
  ...
  subtitle: "Byt 3+1 · Duchcov – Osecká 77",
  ...
  reasons: [
    ...
    { title: "Dispozice 3+1 pro rodiny", text: "Segment 3+1 odpovídá poptávce po větším bytě pro rodiny. Stabilní cílová skupina nájemců s dlouhodobou perspektivou bydlení." },
