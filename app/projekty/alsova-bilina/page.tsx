...
const project = {
  ...
  // Galerie – nahraď src cestami k reálným fotkám v /public/images/alsova-bilina/
  gallery: [
    { src: "/images/alsova-bilina/obyvaci.jpg", label: "Obývací prostor" },
    { src: "/images/alsova-bilina/loznice.jpg", label: "Ložnice" },
    { src: "/images/alsova-bilina/kuchyn.jpg", label: "Kuchyňský kout" },
    { src: "/images/alsova-bilina/koupelna.jpg", label: "Koupelna" },
    { src: "/images/alsova-bilina/dispozice.jpg", label: "Dispozice" },
    { src: "/images/alsova-bilina/lokalita.jpg", label: "Lokalita" },
  ],
