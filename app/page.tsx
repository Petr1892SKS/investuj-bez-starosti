...
const TEAM_ICONS: Record<string, React.ReactNode> = {
  ...
  key: <><path d="M2.586 17.414A2 2 0 0 0 2 18.828V21a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-1a1 1 0 0 0 1-1h1a1 1 0 0 0 1-1v-1a1 1 0 0 0 1-1h.172a2 2 0 0 0 1.414-.586l.814-.814a6.5 6.5 0 1 0-4-4z"/><circle cx="16.5" cy="7.5" r="1" fill="#366dff" stroke="none"/></>,
...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    trackLead("web-formular", eventId);
  };
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        @media(max-width:640px){
          ...
          .projects-grid .project-card.reveal{opacity:1;transform:none;transition:none;}
        }
        ...
        @media(hover:hover){.project-card:hover .project-cta{gap:9px;}}
        .project-card.is-new{border-color:rgba(217,119,6,0.35);box-shadow:0 6px 24px rgba(217,119,6,0.08);}
        @media(hover:hover){.project-card.is-new:hover{border-color:rgba(217,119,6,0.55);}}
        ...
        .team-avatar{width:44px;height:44px;border-radius:12px;background:var(--blue-light);display:flex;align-items:center;justify-content:center;margin:0 auto 0.875rem;}
              ...
              {team.slice(1).map((member, i) => (
                <div key={i} className={`team-card${cls === "team-grid" ? ` reveal d${i+1}` : ""}`}>
                  <div className="team-avatar">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#366dff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
